        ...
        <div className="col-md-4">
          <div className="card text-dark bg-light mb-3">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                "The hospital's facilities are outstanding. From the doctors to
                the nurses, everyone was very attentive and caring. I'm grateful
        ...
        <div className="col-md-4">
          <div className="card text-dark bg-light mb-3">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                "The hospital's staff went above and beyond to ensure my comfort
